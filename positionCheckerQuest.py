...
grammar = [
    ...
    # ---------------------------------------------------------------------------------------------
    {
        "pattern": ["SCONJ", "PRON", "AUX", "VERB", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[0, 2, 1, 3, 4],
        "example":"how are you doing"  # sudah dicek
    },
    {
        "pattern": ["SCONJ", "NOUN", "AUX", "VERB", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[0, 2, 1, 3, 4],
        "example":"how are people doing"  # sudah dicek
    },
    {
        "pattern": ["SCONJ", "PRON", "AUX", "VERB", "DET", "NOUN", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[0, 2, 1, 3, 4, 5, 6],
        "example":"how are you cooking the food"  # sudah dicek
    },
    {
        "pattern": ["SCONJ", "PRON", "AUX", "PART", "VERB", "DET", "NOUN", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[0, 2, 1, 3, 4, 5, 6, 7],
        "example":"how are you not cooking the food"  # sudah dicek
    },
    {
        "pattern": ["SCONJ", "NOUN", "AUX", "VERB", "DET", "NOUN", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[0, 2, 1, 3, 4, 5, 6],
        "example":"how are people cooking the food"  # sudah dicek
    },
    {
        "pattern": ["SCONJ", "NOUN", "AUX", "PART", "VERB", "DET", "NOUN", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[0, 2, 1, 3, 4, 5, 6, 7],
        "example":"how are people not cooking the food"  # sudah dicek
    },
    {
        "pattern": ["SCONJ", "ADV", "PRON", "AUX", "VERB", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[0, 1, 3, 2, 4, 5],
        "example":"how long are you doing"  # sudah dicek
    },
    {
        "pattern": ["SCONJ", "ADV", "PRON", "AUX", "VERB", "DET", "NOUN", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[0, 1, 3, 2, 4, 5, 6, 7],
        "example":"how long are you cooking the food"  # sudah dicek
    },
    {
        "pattern": ["SCONJ", "ADV", "PRON", "AUX", "PART", "VERB", "DET", "NOUN", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[0, 1, 3, 2, 4, 5, 6, 7, 8],
        "example":"how long are you not cooking the food"  # sudah dicek
    },
    {
        "pattern": ["SCONJ", "ADJ", "PRON", "AUX", "VERB", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[0, 1, 3, 2, 4, 5],
        "example":"how much are you doing"  # sudah dicek
    },
    {
        "pattern": ["SCONJ", "ADJ", "PRON", "AUX", "VERB", "DET", "NOUN", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[0, 1, 3, 2, 4, 5, 6, 7],
        "example":"how much are you cooking the food"  # sudah dicek
    },
    {
        "pattern": ["SCONJ", "ADJ", "PRON", "AUX", "PART", "VERB", "DET", "NOUN", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[0, 1, 3, 2, 4, 5, 6, 7, 8],
        "example":"how much are you not cooking the food"  # sudah dicek
    },

    {
        "pattern": ["SCONJ", "ADV", "NOUN", "AUX", "VERB", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[0, 1, 3, 2, 4, 5],
        "example":"how long are people doing"  # sudah dicek
    },
    {
        "pattern": ["SCONJ", "ADV", "NOUN", "AUX", "VERB", "DET", "NOUN", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[0, 1, 3, 2, 4, 5, 6, 7],
        "example":"how long are people cooking the food"  # sudah dicek
    },
    {
        "pattern": ["SCONJ", "ADV", "NOUN", "AUX", "PART", "VERB", "DET", "NOUN", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[0, 1, 3, 2, 4, 5, 6, 7, 8],
        "example":"how long are people not cooking the food"  # sudah dicek
    },
    {
        "pattern": ["SCONJ", "ADJ", "NOUN", "AUX", "VERB", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[0, 1, 3, 2, 4, 5],
        "example":"how much are people doing"  # sudah dicek
    },
    {
        "pattern": ["SCONJ", "ADJ", "NOUN", "AUX", "VERB", "DET", "NOUN", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[0, 1, 3, 2, 4, 5, 6, 7],
        "example":"how much are people cooking the food"  # sudah dicek
    },
    {
        "pattern": ["SCONJ", "ADJ", "NOUN", "AUX", "PART", "VERB", "DET", "NOUN", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[0, 1, 3, 2, 4, 5, 6, 7, 8],
        "example":"how much are people not cooking the food"  # sudah dicek
    },
    {
        "pattern": ["PRON", "AUX", "VERB", "ADV", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[1, 0, 2, 3, 4],
        "example":"are you doing here"  # sudah dicek
    },
    {
        "pattern": ["NOUN", "AUX", "VERB", "ADV", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[1, 0, 2, 3, 4],
        "example":"are people doing here"  # sudah dicek
    },
    {
        "pattern": ["PRON", "AUX", "VERB", "DET", "NOUN", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[1, 0, 2, 3, 4, 5],
        "example":"are you cooking the food"  # sudah dicek
    },
    {
        "pattern": ["PRON", "AUX", "PART", "VERB", "DET", "NOUN", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[1, 0, 2, 3, 4, 5, 6],
        "example":"are you not cooking the food"  # sudah dicek
    },
    {
        "pattern": ["NOUN", "AUX", "VERB", "DET", "NOUN", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[1, 0, 2, 3, 4, 5],
        "example":"are people cooking the food"  # sudah dicek
    },
    {
        "pattern": ["NOUN", "AUX", "PART", "VERB", "DET", "NOUN", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[1, 0, 2, 3, 4, 5, 6],
        "example":"are people not cooking the food"  # sudah dicek
    },
    {
        "pattern": ["PRON", "AUX", "VERB", "ADP", "DET", "NOUN", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[1, 0, 2, 3, 4, 5, 6],
        "example":"are you going to the office"  # sudah dicek
    },
    {
        "pattern": ["PRON", "AUX", "PART", "VERB", "ADP", "DET", "NOUN", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[1, 0, 2, 3, 4, 5, 6, 7],
        "example":"are you not going to the office"  # sudah dicek
    },
    {
        "pattern": ["NOUN", "AUX", "VERB", "ADP", "DET", "NOUN", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[1, 0, 2, 3, 4, 5, 6],
        "example":"are people going to the office"  # sudah dicek
    },
    {
        "pattern": ["NOUN", "AUX", "PART", "VERB", "ADP", "DET", "NOUN", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[1, 0, 2, 3, 4, 5, 6, 7],
        "example":"are people not going to the office"  # sudah dicek
    },
    {
        "pattern": ["SCONJ", "PRON", "AUX", "VERB", "ADP", "DET", "NOUN", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[0, 2, 1, 3, 4, 5, 6, 7],
        "example":"when are you going to the office"  # sudah dicek
    },
    {
        "pattern": ["SCONJ", "PRON", "AUX", "PART", "VERB", "ADP", "DET", "NOUN", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[0, 2, 1, 3, 4, 5, 6, 7, 8],
        "example":"when are you not going to the office"  # sudah dicek
    },
    {
        "pattern": ["SCONJ", "NOUN", "AUX", "VERB", "ADP", "DET", "NOUN", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[0, 2, 1, 3, 4, 5, 6, 7],
        "example":"when are people going to the office"  # sudah dicek
    },
    {
        "pattern": ["SCONJ", "NOUN", "AUX", "PART", "VERB", "ADP", "DET", "NOUN", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[0, 2, 1, 3, 4, 5, 6, 7, 8],
        "example":"when are people not going to the office"  # sudah dicek
    },
    {
        "pattern": ["SCONJ", "ADV", "PRON", "AUX", "VERB", "ADP", "DET", "NOUN", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[0, 1, 3, 2, 4, 5, 6, 7, 8],
        "example":"how long are you going to the office"  # sudah dicek
    },
    {
        "pattern": ["SCONJ", "ADV", "PRON", "AUX", "PART", "VERB", "ADP", "DET", "NOUN", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[0, 1, 3, 2, 4, 5, 6, 7, 8, 9],
        "example":"how long are you not going to the office"  # sudah dicek
    },
    {
        "pattern": ["SCONJ", "ADV", "NOUN", "AUX", "VERB", "ADP", "DET", "NOUN", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[0, 1, 3, 2, 4, 5, 6, 7, 8],
        "example":"how long are people going to the office"  # sudah dicek
    },
    {
        "pattern": ["SCONJ", "ADV", "NOUN", "AUX", "PART", "VERB", "ADP", "DET", "NOUN", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[0, 1, 3, 2, 4, 5, 6, 7, 8, 9],
        "example":"how long are people not going to the office"  # sudah dicek
    },
    {
        "pattern": ["SCONJ", "ADJ", "PRON", "AUX", "VERB", "ADP", "DET", "NOUN", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[0, 1, 3, 2, 4, 5, 6, 7, 8],
        "example":"how much are you going to the office"  # sudah dicek
    },
    {
        "pattern": ["SCONJ", "ADJ", "PRON", "AUX", "PART", "VERB", "ADP", "DET", "NOUN", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[0, 1, 3, 2, 4, 5, 6, 7, 8, 9],
        "example":"how much are you not going to the office"  # sudah dicek
    },
    {
        "pattern": ["SCONJ", "ADJ", "NOUN", "AUX", "VERB", "ADP", "DET", "NOUN", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[0, 1, 3, 2, 4, 5, 6, 7, 8],
        "example":"how much are people going to the office"  # sudah dicek
    },
    {
        "pattern": ["SCONJ", "ADJ", "NOUN", "AUX", "PART", "VERB", "ADP", "DET", "NOUN", "PUNCT"],
        "message":"verb placed after pronoun",
        "correction":[0, 1, 3, 2, 4, 5, 6, 7, 8, 9],
        "example":"how much are people not going to the office"  # sudah dicek
    },
    # =============================================================================================================

    {
        ...
        "message":"verb placed after pronoun",
        "correction":[0, 2, 1, 3, 4],
        "example":"how do you go"  # sudah dicek
    },
    {
        "pattern": ["SCONJ", "NOUN", "AUX", "VERB", "PUNCT"],
        "message":"verb placed after pronoun",
...
def position_checker_quest(poss, texts3):
